...
const VisitorProfile = ({ user, onClose, onProfileSubmit, onPasswordChange }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const result = await axios.post(`${apiUrl}/Arteon/Visitor/visitorprofileupdate`, updatedProfile);
